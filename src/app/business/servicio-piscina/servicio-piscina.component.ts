...
export class ServicioPiscinaComponent implements OnInit {
  ...
  exportExcelByFilters(): void {
    ...
    switch (this.filtroActual) {
      case 'FECHA':
        const fechaSeleccionada = new Date(this.fechaInicio!);
        this.servicioPiscinaService.exportExcelServicioPiscina(undefined, undefined, fechaSeleccionada).subscribe(this.descargarExcel, this.handleError);
      ...
      case 'RANGO':
        const desdeSeleccionada = new Date(this.desde!);
        const hastaSeleccionada = new Date(this.hasta!);
        this.servicioPiscinaService.exportExcelServicioPiscina(undefined, undefined, undefined, desdeSeleccionada, hastaSeleccionada).subscribe(this.descargarExcel, this.handleError);
      ...
      case 'METODO_Y_FECHAS':
        const desdeSeleccionada2 = new Date(this.desdeMetodo!);
        const hastaSeleccionada2 = new Date(this.hastaMetodo!);
        this.servicioPiscinaService.exportExcelServicioPiscina(undefined, this.metodoPagoSeleccionado, undefined, desdeSeleccionada2, hastaSeleccionada2).subscribe(this.descargarExcel, this.handleError);
      ...
      case 'DNI':
        this.servicioPiscinaService.exportExcelServicioPiscina(this.dniSeleccionado).subscribe(this.descargarExcel, this.handleError);
